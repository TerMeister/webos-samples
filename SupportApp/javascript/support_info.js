...
_APP_PublisherName = 'Palm DTS'
_APP_Copyright = '&copy; Copyright 2009 Palm DTS.'

// At least one of these three is required
_APP_Support_URL = 'http://pdn.palm.com'   // label = “Support Website”
_APP_Support_Email = {
	address: 'dts@palm.com',
	subject: 'Support'
}        // label = “Send Email”
_APP_Support_Phone = '555-555-5555'        // label = _APP_Support_Phone

// Optional
_APP_Publisher_URL = 'http://www.palm.com' // label = _APP_PublisherName + “Website”
_APP_Help_Resource = [
