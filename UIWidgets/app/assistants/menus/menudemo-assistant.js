...
MenudemoAssistant = Class.create({
	...
	setup: function() {
		...
		*/
		Mojo.Event.listen(this.controller.get('changeMenuButton'), Mojo.Event.tap, this.changeItems.bindAsEventListener(this, 
		...
		Mojo.Event.listen(this.controller.get('dividersButton'), Mojo.Event.tap, this.changeItems.bindAsEventListener(this, 
								[this.dividers1, this.dividers2, this.dividers3, this.dividers4, this.dividers5, this.dividers6, this.dividers7, this.dividers8]));

		Mojo.Event.listen(this.controller.get('togglesButton'), Mojo.Event.tap, this.changeItems.bindAsEventListener(this, 
								[this.toggle1, this.toggle2, this.toggle3, this.toggle4, this.toggle5, this.toggle6]));

		Mojo.Event.listen(this.controller.get('groupsButton'), Mojo.Event.tap, this.changeItems.bindAsEventListener(this, 
								[this.group1, this.group2, this.group3, this.group4, this.group5]));
		
		Mojo.Event.listen(this.controller.get('fancyChangeButton'), Mojo.Event.tap, this.changeItems.bindAsEventListener(this, 
		...
		Mojo.Event.listen(this.controller.get('widthsButton'), Mojo.Event.tap, this.changeItems.bindAsEventListener(this, 
								[this.widths1, this.widths2, this.widths3, this.widths4, this.widths5]));
		
		// This button will show or hide the menubars.
		Mojo.Event.listen(this.controller.get('showHideButton'), Mojo.Event.tap, this.showHide.bindAsEventListener(this));
	...
	*/
	...
	showHide: function(event) {
		...
		this.controller.setMenuVisible(Mojo.commandMenu, this.cmdMenuVisible);
		
		this.viewMenuVisible = !this.viewMenuVisible;
		this.controller.setMenuVisible(Mojo.viewMenu, this.viewMenuVisible);
		*/
