...
SubwidgetsAssistant.prototype.setup = function() {
	...
	this.controller.setupWidget('listToggle1', {property : 'volume', choices:this.laughTypes});
	this.controller.setupWidget('listToggle2', {property : 'frequency', choices:this.laughFreq});    
