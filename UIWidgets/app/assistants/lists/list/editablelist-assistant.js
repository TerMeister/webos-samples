...
EditablelistAssistant.prototype.setup = function(){
		...
		this.switchModels = this.switchModels.bindAsEventListener(this);;
		this.focusRandom = this.focusRandom.bindAsEventListener(this);
		this.changeAddItem = this.changeAddItem.bindAsEventListener(this);
		this.changeListVisible = this.changeListVisible.bindAsEventListener(this);
