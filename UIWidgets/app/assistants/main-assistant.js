...
MainAssistant.prototype.setupModel = function(){
	this.widgets = [
			...
			{category:$L("Indicators"), directory:$L("indicators/progressSlider"), name:$L("Progress Slider"), scene:$L("progressSlider"), description:$L("Work In Progress")},
			...
			{category:$L("Lists"), directory:$L("lists/subwidgets"), name:$L("Widgets in a List"), scene:$L("subwidgets")},
