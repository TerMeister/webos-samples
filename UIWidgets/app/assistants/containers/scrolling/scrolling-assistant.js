...
ScrollingAssistant.prototype.setup = function() {
	...
	this.frictionValues = {low: 0.06, medium: 0.2, high: 0.5}
		...
		this.sizeChanged = this.sizeChanged.bindAsEventListener(this);
		this.modeChanged.bindAsEventListener(this);
		this.weightChanged.bindAsEventListener(this);
		this.frictionChanged.bindAsEventListener(this);
		...
		this.controller.listen('dog_img', 'load', this.rememberImageSize.bindAsEventListener(this));
		...
		this.snap = this.snap.bindAsEventListener(this);
	}
